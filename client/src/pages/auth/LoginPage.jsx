      ...
      >
        <div className="glass-card p-8 rounded-3xl relative overflow-hidden group">
          ...
          <div className="text-center mb-10 relative">
            ...
            <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Registry Node</h1>
            <p className="text-gray-400 text-sm">Secure Administrative Access Protocol</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative">
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-gray-500 uppercase tracking-widest pl-1">Grid Identity</label>
