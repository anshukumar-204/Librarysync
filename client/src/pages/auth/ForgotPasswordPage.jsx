  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (forgotPasswordAdmin.fulfilled.match(resultAction)) {
        toast.success("Security OTP disseminated. Check your nodes.");
        navigate('/reset-password', { state: { email } });
      } else {
        toast.error(resultAction.payload || "Protocol Failure");
      }
    } catch (err) {
      toast.error("Communication Loss");
    } finally {
      ...
      >
        <div className="glass-card p-8 rounded-3xl">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Recover Node Access</h1>
            <p className="text-gray-400 text-sm leading-relaxed">
              Enter your registered grid email to receive a secure authentication code.
            </p>
          </div>
